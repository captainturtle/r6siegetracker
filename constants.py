...
STATS_URL = 'https://public-ubiservices.ubi.com/v1/spaces/5172a557-50b5-4665-b7db-e3f2e8c5041d/sandboxes/OSBOR_PC_LNCH_A/playerstats2/statistics?populations={id}&' +\
            'statistics=rankedpvp_kills,rankedpvp_death,rankedpvp_matchwon,rankedpvp_matchlost,casualpvp_kills,casualpvp_death,casualpvp_matchwon,casualpvp_matchlost,generalpvp_bullethit,generalpvp_bulletfired'
...
STAT_LIST = [
    ...
    ('generalpvp_bullethit:infinite', 'bullet_hit', 'Bullets Hit'),
    ('generalpvp_bulletfired:infinite', 'bullet_fired', 'Bullets Fired')
    ]