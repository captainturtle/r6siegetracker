...
STAT_LIST = [
    ('rankedpvp_kills:infinite', 'ranked_kill'),
    ('rankedpvp_death:infinite', 'ranked_death'),
    ('rankedpvp_matchwon:infinite', 'ranked_won'),
    ('rankedpvp_matchlost:infinite', 'ranked_lost'),
    ('casualpvp_kills:infinite', 'casual_kill'),
    ('casualpvp_death:infinite', 'casual_death'),
    ('casualpvp_matchwon:infinite', 'casual_won'),
    ('casualpvp_matchlost:infinite', 'casual_lost')
    ]